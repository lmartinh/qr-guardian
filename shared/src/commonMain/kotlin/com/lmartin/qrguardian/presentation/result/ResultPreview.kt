...
private fun sampleUrlResult(level: SecurityLevel): QrAnalysisResult {
...
private fun sampleNoRemoteResult(): QrAnalysisResult {
    return sampleUrlResult(SecurityLevel.Safe).copy(
        remoteReputation = ScanSectionResult(
            name = "Remote reputation",
...
private fun samplePdfDownloadResult(): QrAnalysisResult {
    return QrAnalysisResult(
...
private fun sampleMailResult(): QrAnalysisResult {
    return QrAnalysisResult(
...
private fun samplePlainTextResult(): QrAnalysisResult {
    return QrAnalysisResult(
