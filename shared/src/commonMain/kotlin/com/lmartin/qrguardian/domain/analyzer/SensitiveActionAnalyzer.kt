...
class SensitiveActionAnalyzer {
    ...
    fun analyzePhone(text: String): LocalSecurityCheck {
        return LocalSecurityCheck(
            level = SecurityLevel.Suspicious,
    ...
    fun analyzeCrypto(text: String): LocalSecurityCheck {
        return LocalSecurityCheck(
            level = SecurityLevel.Suspicious,
    ...
    fun analyzeVCard(text: String): LocalSecurityCheck {
        return LocalSecurityCheck(
    ...
    fun analyzeGeo(text: String): LocalSecurityCheck {
        return LocalSecurityCheck(
            level = SecurityLevel.Unknown,
